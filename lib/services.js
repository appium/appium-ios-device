...
async function startWebInspectorService (udid, version, socket) {
  return new WebInspectorService(version, await startService(udid, WEB_INSPECTOR_SERVICE_NAME, socket));
}
