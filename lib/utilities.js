...
/**
 * Retrieves time offset from UTC for the current device's time zone
 *
...
async function getDeviceTime (udid, socket) {
  ...
  try {
    ...
    timestamp.setUTCSeconds(epochValue);
...
export {
  ...
  startLockdownSession, connectPort, connectPortSSL, getTimeZoneOffset,
};
