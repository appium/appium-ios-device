 ...
 * @returns {string} Human-readable size string (e.g., "1.23 MB", "456.78 KB")
 */
function toReadableSizeString(bytes, decimals = 2) {
...
export {
  ...
  fetchImageFromGithubRepo, toReadableSizeString
};
