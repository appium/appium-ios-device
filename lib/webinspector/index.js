...
class WebInspectorService extends BaseServiceSocket {
  ...
  constructor (opts = {}) {
    ...
    if (_.isFunction(socketClient.setMaxSendFragment) && !_.isNil(socketChunkSize) && socketChunkSize !== null && socketChunkSize !== undefined && socketChunkSize > 0) {
    ...
    if (!isSimulator && !_.isNil(majorOsVersion) && majorOsVersion !== undefined && majorOsVersion < PARTIAL_MESSAGE_SUPPORT_DEPRECATION_VERSION) {
