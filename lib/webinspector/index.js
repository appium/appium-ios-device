...
class WebInspectorService extends BaseServiceSocket {
  ...
  constructor (opts = {}) {
    ...
    if (_.isFunction(socketClient.setMaxSendFragment) && _.isNumber(socketChunkSize) && socketChunkSize > 0) {
    ...
    if (!isSimulator && _.isNumber(majorOsVersion) && majorOsVersion < PARTIAL_MESSAGE_SUPPORT_DEPRECATION_VERSION) {
