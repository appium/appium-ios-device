...
class LengthBasedSplitter extends Stream.Transform {
  ...
  constructor (littleEndian, maxFrameLength, lengthFieldOffset, lengthFieldLength, lengthAdjustment, decodeSingleObject = true) {
    super();
    ...
    this.decodeSingleObject = decodeSingleObject;
