...
async function getDefaultSocket(opts = {}) {
  ...
  opts = { ...getSocketOptionsFromEnv(opts), ...opts }

  let { socketPath, socketHost, socketPort, timeout, useHostPort } = { ...opts, useHostPort: !!(opts.socketHost || opts.socketPort) };

  socketPath = opts.socketPath ?? defaults.socketPath;
  socketHost = opts.socketHost || defaults.socketHost;
  socketPort = opts.socketPort || defaults.socketPort;
