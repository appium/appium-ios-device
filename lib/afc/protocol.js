...
const Operations_Code = Object.fromEntries(Object.entries(Operations).map(([key, value]) => [value, key]));
...
const Errors_Code = Object.fromEntries(Object.entries(Errors).map(([key, value]) => [value, key]));
