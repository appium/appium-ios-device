...
class InstrumentService extends BaseServiceSocket {
   ...
   * @param {string} channel instruments service channel e.g: CHANNEL.DEVICE_INFO.
   * @param {DTXCallback} event
   */
   ...
   * @param {string} channel instrument dtx service e.g: CHANNEL.DEVICE_INFO
   ...
   * example：
   * instrumentService.callChannel(CHANNEL.PROCESS_CONTROL,
